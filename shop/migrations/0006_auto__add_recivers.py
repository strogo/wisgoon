...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Recivers'
        db.create_table(u'shop_recivers', (
            ...
            ('postal_code', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'shop', ['Recivers'])


    def backwards(self, orm):
        # Deleting model 'Recivers'
        db.delete_table(u'shop_recivers')
    ...
    models = {
        ...
        u'shop.recivers': {
            'Meta': {'object_name': 'Recivers'},
            'address': ('django.db.models.fields.TextField', [], {}),
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'postal_code': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
