...
from rss.models import Feed, Item, Subscribe, Search, Category
...
class CategoryAdmin(admin.ModelAdmin):
    list_display = ('name', 'en_title')

class FeedAdmin(admin.ModelAdmin):
    list_display = \
    ('url','title','last_fetch','followers','view','priority','creator','status','lock', 'category')
    fields = ('url','category')
    actions = [feed_unlock]
    list_filter = ('lock','category')
