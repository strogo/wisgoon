...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.image_local'
        db.add_column('rss_item', 'image_local',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.image_local'
        db.delete_column('rss_item', 'image_local')
    ...
    models = {
        ...
        'rss.item': {
            ...
            'image_local': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
