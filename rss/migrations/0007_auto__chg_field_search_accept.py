...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Search.accept'
        db.alter_column('rss_search', 'accept', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Search.accept'
        db.alter_column('rss_search', 'accept', self.gf('django.db.models.fields.IntegerField')())
