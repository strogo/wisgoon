...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Search.slug'
        db.add_column('rss_search', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Search.slug'
        db.delete_column('rss_search', 'slug')
    ...
    models = {
        ...
        'rss.search': {
            ...
            'accept': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
