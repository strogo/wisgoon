...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rss_feed', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['rss.Category'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rss_feed', 'category_id')
