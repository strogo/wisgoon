...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Profile', fields ['score']
        db.create_index('user_profile_profile', ['score'])


    def backwards(self, orm):
        # Removing index on 'Profile', fields ['score']
        db.delete_index('user_profile_profile', ['score'])
