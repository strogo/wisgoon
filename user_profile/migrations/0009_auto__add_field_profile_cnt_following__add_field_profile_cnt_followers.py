...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.cnt_following'
        db.add_column(u'user_profile_profile', 'cnt_following',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.cnt_followers'
        db.add_column(u'user_profile_profile', 'cnt_followers',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.credit'
        db.add_column(u'user_profile_profile', 'credit',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.level'
        db.add_column(u'user_profile_profile', 'level',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.cnt_following'
        db.delete_column(u'user_profile_profile', 'cnt_following')

        # Deleting field 'Profile.cnt_followers'
        db.delete_column(u'user_profile_profile', 'cnt_followers')

        # Deleting field 'Profile.credit'
        db.delete_column(u'user_profile_profile', 'credit')

        # Deleting field 'Profile.level'
        db.delete_column(u'user_profile_profile', 'level')
