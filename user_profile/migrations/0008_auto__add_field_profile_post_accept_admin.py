...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.post_accept_admin'
        db.add_column('user_profile_profile', 'post_accept_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.post_accept_admin'
        db.delete_column('user_profile_profile', 'post_accept_admin')
