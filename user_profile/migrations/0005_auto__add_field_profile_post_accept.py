...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.post_accept'
        db.add_column('user_profile_profile', 'post_accept',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.post_accept'
        db.delete_column('user_profile_profile', 'post_accept')
