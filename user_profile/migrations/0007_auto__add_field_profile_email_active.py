...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.email_active'
        db.add_column('user_profile_profile', 'email_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.email_active'
        db.delete_column('user_profile_profile', 'email_active')
    ...
    models = {
        ...
        'user_profile.profile': {
            ...
            'activation_key': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '50'}),
