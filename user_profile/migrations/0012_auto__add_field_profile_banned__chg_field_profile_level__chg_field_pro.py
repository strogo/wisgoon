...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'user_profile_profile', 'banned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Profile.level'
        db.alter_column(u'user_profile_profile', 'level', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Profile.credit'
        db.alter_column(u'user_profile_profile', 'credit', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Deleting field 'Profile.banned'
        db.delete_column(u'user_profile_profile', 'banned')


        # Changing field 'Profile.level'
        db.alter_column(u'user_profile_profile', 'level', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Profile.credit'
        db.alter_column(u'user_profile_profile', 'credit', self.gf('django.db.models.fields.IntegerField')(null=True))
