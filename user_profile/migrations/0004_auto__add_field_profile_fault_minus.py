...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.fault_minus'
        db.add_column('user_profile_profile', 'fault_minus',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.fault_minus'
        db.delete_column('user_profile_profile', 'fault_minus')
