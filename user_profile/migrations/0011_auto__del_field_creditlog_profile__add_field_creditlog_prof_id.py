...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CreditLog.profile'
        db.delete_column(u'user_profile_creditlog', 'profile_id')

        # Adding field 'CreditLog.prof_id'
        db.add_column(u'user_profile_creditlog', 'prof_id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CreditLog.profile'
        raise RuntimeError("Cannot reverse this migration. 'CreditLog.profile' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CreditLog.profile'
        db.add_column(u'user_profile_creditlog', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_credit_log', to=orm['user_profile.Profile']),
                      keep_default=False)

        # Deleting field 'CreditLog.prof_id'
        db.delete_column(u'user_profile_creditlog', 'prof_id')
