...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pin_posttag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Tag'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Post'])),
        ))
        db.send_create_signal('pin', ['PostTag'])

        # Adding model 'Tag'
        db.create_table('pin_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('pin', ['Tag'])


    def backwards(self, orm):
        # Deleting model 'PostTag'
        db.delete_table('pin_posttag')

        # Deleting model 'Tag'
        db.delete_table('pin_tag')
    ...
    models = {
        ...
        'pin.posttag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pin.Post']"}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pin.Tag']"})
        },
        'pin.stream': {
