...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BannedImei.description'
        db.add_column(u'pin_bannedimei', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'BannedImei.user'
        db.add_column(u'pin_bannedimei', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BannedImei.description'
        db.delete_column(u'pin_bannedimei', 'description')

        # Deleting field 'BannedImei.user'
        db.delete_column(u'pin_bannedimei', 'user_id')
    ...
    models = {
        ...
        u'pin.bannedimei': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 6, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
        ...
        u'pin.storages': {
            'Meta': {'object_name': 'Storages'},
            'host': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'num_files': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
