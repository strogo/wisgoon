...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pin_post', 'url', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Post.url'
        db.alter_column('pin_post', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
