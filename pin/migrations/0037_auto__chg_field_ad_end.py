...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ad.end'
        db.alter_column(u'pin_ad', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ad.end'
        raise RuntimeError("Cannot reverse this migration. 'Ad.end' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Ad.end'
        db.alter_column(u'pin_ad', 'end', self.gf('django.db.models.fields.DateTimeField')())
