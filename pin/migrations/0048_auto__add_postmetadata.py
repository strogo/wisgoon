...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pin_postmetadata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pin.Post'], unique=True)),
            ('original_size', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1, db_index=True)),
            ('img_236_h', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('img_500_h', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('img_236', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('img_500', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'pin', ['PostMetaData'])


    def backwards(self, orm):
        # Deleting model 'PostMetaData'
        db.delete_table(u'pin_postmetadata')
    ...
    models = {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
        ...
        u'pin.log': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'default': "'127.0.0.1'", 'max_length': '15', 'db_index': 'True'}),
