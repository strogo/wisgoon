...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Bills2', fields ['trans_id']
        db.create_index(u'pin_bills2', ['trans_id'])


    def backwards(self, orm):
        # Removing index on 'Bills2', fields ['trans_id']
        db.delete_index(u'pin_bills2', ['trans_id'])
