...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sim.fetures'
        db.delete_column(u'pin_sim', 'fetures')

        # Adding field 'Sim.features'
        db.add_column(u'pin_sim', 'features',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Sim.fetures'
        raise RuntimeError("Cannot reverse this migration. 'Sim.fetures' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Sim.fetures'
        db.add_column(u'pin_sim', 'fetures',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'Sim.features'
        db.delete_column(u'pin_sim', 'features')
    ...
    models = {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
