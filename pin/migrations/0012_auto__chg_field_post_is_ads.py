...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.is_ads'
        db.alter_column('pin_post', 'is_ads', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Post.is_ads'
        db.alter_column('pin_post', 'is_ads', self.gf('django.db.models.fields.IntegerField')())
