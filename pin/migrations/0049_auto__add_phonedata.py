...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhoneData'
        db.create_table(u'pin_phonedata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='phone', null=True, to=orm['auth.User'])),
            ('imei', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('os', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('phone_model', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('phone_serial', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('android_version', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('app_version', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('google_token', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'pin', ['PhoneData'])


    def backwards(self, orm):
        # Deleting model 'PhoneData'
        db.delete_table(u'pin_phonedata')
    ...
    models = {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
        ...
        u'pin.log': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'default': "'127.0.0.1'", 'max_length': '15', 'db_index': 'True'}),
