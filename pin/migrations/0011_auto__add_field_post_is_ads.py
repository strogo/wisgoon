...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.is_ads'
        db.add_column('pin_post', 'is_ads',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.is_ads'
        db.delete_column('pin_post', 'is_ads')
    ...
    models = {
        ...
        'pin.post': {
            ...
            'is_ads': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
