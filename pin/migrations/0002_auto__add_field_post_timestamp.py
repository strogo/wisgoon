...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pin_post', 'timestamp',
                      self.gf('django.db.models.fields.IntegerField')(default=1347546432, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.timestamp'
        db.delete_column('pin_post', 'timestamp')
