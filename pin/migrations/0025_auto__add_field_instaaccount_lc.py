...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstaAccount.lc'
        db.add_column(u'pin_instaaccount', 'lc',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 17, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstaAccount.lc'
        db.delete_column(u'pin_instaaccount', 'lc')
    ...
    models = {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 17, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
