...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Storages'
        db.create_table(u'pin_storages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('used', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('num_files', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'pin', ['Storages'])


    def backwards(self, orm):
        # Deleting model 'Storages'
        db.delete_table(u'pin_storages')
    ...
    models = {
        ...
        u'pin.bannedimei': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 29, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
