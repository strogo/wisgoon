...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Actors'
        db.create_table('pin_actors', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notify', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notify', to=orm['pin.Notify'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notify_user', to=orm['auth.User'])),
        ))
        db.send_create_signal('pin', ['Actors'])
    ...
    models = {
        ...
        'pin.actors': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notify': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notify'", 'to': "orm['pin.Notify']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notify_user'", 'to': "orm['auth.User']"})
        },
        'pin.app_data': {
        ...
        'pin.notify': {
            ...
            'actors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'actors'", 'symmetrical': 'False', 'through': "orm['pin.Actors']", 'to': "orm['auth.User']"}),
