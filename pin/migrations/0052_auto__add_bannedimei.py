...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BannedImei'
        db.create_table(u'pin_bannedimei', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('imei', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
        ))
        db.send_create_signal(u'pin', ['BannedImei'])


    def backwards(self, orm):
        # Deleting model 'BannedImei'
        db.delete_table(u'pin_bannedimei')
