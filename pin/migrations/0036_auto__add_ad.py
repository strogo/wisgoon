...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ad'
        db.create_table(u'pin_ad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ended', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('cnt_view', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Post'])),
            ('ads_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('start', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'pin', ['Ad'])


    def backwards(self, orm):
        # Deleting model 'Ad'
        db.delete_table(u'pin_ad')
