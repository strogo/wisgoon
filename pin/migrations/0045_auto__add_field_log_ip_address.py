...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.ip_address'
        db.add_column(u'pin_log', 'ip_address',
                      self.gf('django.db.models.fields.IPAddressField')(default='127.0.0.1', max_length=15, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Log.ip_address'
        db.delete_column(u'pin_log', 'ip_address')
