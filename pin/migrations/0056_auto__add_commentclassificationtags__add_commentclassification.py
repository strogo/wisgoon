...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentClassificationTags'
        db.create_table(u'pin_commentclassificationtags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'pin', ['CommentClassificationTags'])

        # Adding model 'CommentClassification'
        db.create_table(u'pin_commentclassification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.CommentClassificationTags'])),
        ))
        db.send_create_signal(u'pin', ['CommentClassification'])


    def backwards(self, orm):
        # Deleting model 'CommentClassificationTags'
        db.delete_table(u'pin_commentclassificationtags')

        # Deleting model 'CommentClassification'
        db.delete_table(u'pin_commentclassification')
    ...
    models = {
        ...
        u'pin.bannedimei': {
            'Meta': {'object_name': 'BannedImei'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 3, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imei': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'})
        },
        u'pin.bills2': {
        ...
        u'pin.commentclassification': {
            'Meta': {'object_name': 'CommentClassification'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pin.CommentClassificationTags']"}),
            'text': ('django.db.models.fields.TextField', [], {})
        },
        u'pin.commentclassificationtags': {
            'Meta': {'object_name': 'CommentClassificationTags'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'pin.comments': {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 3, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
        ...
        u'pin.phonedata': {
            ...
            'android_version': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'app_version': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'google_token': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'hash_data': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'phone'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'pin.post': {
            ...
            'cnt_comment': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
