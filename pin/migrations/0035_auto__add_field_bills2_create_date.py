...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bills2.create_date'
        db.add_column(u'pin_bills2', 'create_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bills2.create_date'
        db.delete_column(u'pin_bills2', 'create_date')
    ...
    models = {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 17, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
