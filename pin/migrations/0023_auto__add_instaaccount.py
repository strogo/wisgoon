...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstaAccount'
        db.create_table(u'pin_instaaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('insta_id', self.gf('django.db.models.fields.IntegerField')()),
            ('cat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Category'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'pin', ['InstaAccount'])


    def backwards(self, orm):
        # Deleting model 'InstaAccount'
        db.delete_table(u'pin_instaaccount')
