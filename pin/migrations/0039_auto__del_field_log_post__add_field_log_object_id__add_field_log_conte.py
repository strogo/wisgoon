...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Log.post'
        db.delete_column(u'pin_log', 'post')

        # Adding field 'Log.object_id'
        db.add_column(u'pin_log', 'object_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Log.content_type'
        db.add_column(u'pin_log', 'content_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Log.post_image'
        db.add_column(u'pin_log', 'post_image',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Log.post'
        db.add_column(u'pin_log', 'post',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Log.object_id'
        db.delete_column(u'pin_log', 'object_id')

        # Deleting field 'Log.content_type'
        db.delete_column(u'pin_log', 'content_type')

        # Deleting field 'Log.post_image'
        db.delete_column(u'pin_log', 'post_image')
