...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sim'
        db.create_table(u'pin_sim', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pin.Post'], unique=True)),
            ('fetures', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'pin', ['Sim'])


    def backwards(self, orm):
        # Deleting model 'Sim'
        db.delete_table(u'pin_sim')
    ...
    models = {
        ...
        u'pin.sim': {
            ...
            'fetures': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
