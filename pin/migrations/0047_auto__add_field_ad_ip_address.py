...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ad.ip_address'
        db.add_column(u'pin_ad', 'ip_address',
                      self.gf('django.db.models.fields.IPAddressField')(default='127.0.0.1', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ad.ip_address'
        db.delete_column(u'pin_ad', 'ip_address')
    ...
    models = {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
        ...
        u'pin.log': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'default': "'127.0.0.1'", 'max_length': '15', 'db_index': 'True'}),
