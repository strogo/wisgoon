...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notify.date'
        db.add_column('pin_notify', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notify.date'
        db.delete_column('pin_notify', 'date')
