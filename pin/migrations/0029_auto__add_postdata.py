...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pin_postdata', (
            ...
            ('img_236_h', self.gf('django.db.models.fields.IntegerField')()),
            ('img_500', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('img_500_h', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'pin', ['PostData'])


    def backwards(self, orm):
        # Deleting model 'PostData'
        db.delete_table(u'pin_postdata')
