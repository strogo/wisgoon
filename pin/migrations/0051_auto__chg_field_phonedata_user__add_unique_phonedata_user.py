...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhoneData.user'
        db.alter_column(u'pin_phonedata', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['auth.User']))
        # Adding unique constraint on 'PhoneData', fields ['user']
        db.create_unique(u'pin_phonedata', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PhoneData', fields ['user']
        db.delete_unique(u'pin_phonedata', ['user_id'])


        # Changing field 'PhoneData.user'
        db.alter_column(u'pin_phonedata', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
