...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostData.post'
        db.alter_column(u'pin_postdata', 'post_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pin.Post'], unique=True))
        # Adding unique constraint on 'PostData', fields ['post']
        db.create_unique(u'pin_postdata', ['post_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PostData', fields ['post']
        db.delete_unique(u'pin_postdata', ['post_id'])


        # Changing field 'PostData.post'
        db.alter_column(u'pin_postdata', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Post']))
    ...
    models = {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
        ...
        u'pin.postdata': {
            ...
            'img_236_h': ('django.db.models.fields.IntegerField', [], {}),
            'img_500': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'img_500_h': ('django.db.models.fields.IntegerField', [], {}),
