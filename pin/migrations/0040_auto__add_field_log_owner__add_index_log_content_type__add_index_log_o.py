...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.owner'
        db.add_column(u'pin_log', 'owner',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding index on 'Log', fields ['content_type']
        db.create_index(u'pin_log', ['content_type'])

        # Adding index on 'Log', fields ['object_id']
        db.create_index(u'pin_log', ['object_id'])

        # Adding index on 'Log', fields ['action']
        db.create_index(u'pin_log', ['action'])


    def backwards(self, orm):
        # Removing index on 'Log', fields ['action']
        db.delete_index(u'pin_log', ['action'])

        # Removing index on 'Log', fields ['object_id']
        db.delete_index(u'pin_log', ['object_id'])

        # Removing index on 'Log', fields ['content_type']
        db.delete_index(u'pin_log', ['content_type'])

        # Deleting field 'Log.owner'
        db.delete_column(u'pin_log', 'owner')
    ...
    models = {
        ...
        u'pin.bills2': {
            ...
            'trans_id': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.block': {
        ...
        u'pin.instaaccount': {
            ...
            'lc': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pin.likes': {
