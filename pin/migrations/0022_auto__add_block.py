...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Block'
        db.create_table(u'pin_block', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blocker', to=orm['auth.User'])),
            ('blocked', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blocked', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'pin', ['Block'])


    def backwards(self, orm):
        # Deleting model 'Block'
        db.delete_table(u'pin_block')
