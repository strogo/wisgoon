...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.hash'
        db.alter_column('pin_post', 'hash', self.gf('django.db.models.fields.CharField')(max_length=32))
        # Adding index on 'Post', fields ['hash']
        db.create_index('pin_post', ['hash'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['hash']
        db.delete_index('pin_post', ['hash'])


        # Changing field 'Post.hash'
        db.alter_column('pin_post', 'hash', self.gf('django.db.models.fields.CharField')(max_length=100))
