...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Notify_post_actors'
        db.create_table('pin_notify_post_actors', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notify', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pin.Notify'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('pin', ['Notify_post_actors'])

        # Deleting field 'Notify.sender'
        db.delete_column('pin_notify', 'sender_id')


    def backwards(self, orm):
        # Deleting model 'Notify_post_actors'
        db.delete_table('pin_notify_post_actors')


        # User chose to not deal with backwards NULL issues for 'Notify.sender'
        raise RuntimeError("Cannot reverse this migration. 'Notify.sender' and its values cannot be restored.")
    ...
    models = {
        ...
        'pin.notify': {
            ...
            'actors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'actors'", 'symmetrical': 'False', 'through': "orm['pin.Notify_post_actors']", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'pin.notify_post_actors': {
            'Meta': {'object_name': 'Notify_post_actors'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notify': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pin.Notify']"}),
