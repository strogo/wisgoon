...
urlpatterns += patterns('pin.views_user',
    ...
    url(r'^following/activity/$', 'notif_following',
        name="pin-notif-user-following"),
    ...
    url(r'^follow/(?P<following>\d+)/(?P<action>\d+)/$', 'follow',
        name='pin-follow'),
    url(r'^send_comment/', 'send_comment', name='pin-comment'),
    url(r'^comment/score/(?P<comment_id>\d+)/(?P<score>\d+)', 'comment_score',
        name="pin-comment-score"),
    ...
    url(r'^verify_payment/(?P<bill_id>\w+)/$', 'verify_payment',
        name="pin-verify-payment"),
    url(r'^save/as/ads/(?P<post_id>\w+)/$', 'save_as_ads',
        name="pin-save-as-ads"),
    url(r'^user/action/(?P<user_id>\d+)/$', 'block_action',
        name="pin-user-block"),
    url(r'^blocked/$', 'blocked_list', name="blocked-list"),
    url(r'^promotion/$', 'promotion_list', name="promotion-list"),
    url(r'^remove/follow/request/(?P<following>\d+)/$', 'remove_follow_req',
        name="remove-follow-request"),
    url(r'^follow/requests/$', 'follow_requests', name="pin-follow-request"),
    url(r'^follow/accept/request/$', 'accept_follow',
        name="pin-accept-follow-request"),
)
